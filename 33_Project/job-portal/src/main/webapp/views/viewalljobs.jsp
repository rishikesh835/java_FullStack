    ...
    <%@ taglib prefix="ab" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ page isELIgnored="false" %>
            <%@ page import="java.util.List" %>
                <%@ page import="com.learning.job_portal.model.JobPost" %>
                    <%@ page import="com.learning.job_portal.repo.JobRepo" %>
                        <!DOCTYPE html>
                        <html lang="en">
                                ...
                                <div class="container">
                                    ...
                                    <div class="collapse navbar-collapse" id="navbarNav">
                                        <ul class="navbar-nav ms-auto">
                                            ...
                                            <li class="nav-item"><a class="nav-link" href="viewalljobs">All Jobs</a>
                                            </li>
